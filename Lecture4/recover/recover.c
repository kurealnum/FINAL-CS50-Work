...
//Open the file, and start writing to a new JPEG file
//Stop at the end of the file

//JPEG header starts with 0xff 0xd8 0xff, and ends with 0xe0, 0xe1, 0xe2, or anything up to 0xef
//Each JPEG is stored back to back in the card
